...
class LoadStreams:
    ...
    def __init__(self, sources='0', img_size=480, stride=32, auto=True, transforms=None, vid_stride=1, xsize=848, ysize=480, fps = 15):
        ...
        self.imgs, self.depth, self.fps, self.frames, self.threads = [None] * n, [None] * n, [0] * n, [0] * n, [None] * n
    ...
    def get_frame(self, i, xsize, ysize, fps):
        ...
        if self.sources[0] == 'rs':
            ...
            jsonObj = json.load(open("/home/ieeefiu/Desktop/rs-opencv/rs_config.json"))
            ...
            self.my_color_image = np.asanyarray(color_frame.get_data())               
            ...
            self.imgs[i] = self.my_color_image
    ...
    def __next__(self):
        ...
        return self.sources, im, im0, self.depth, None, ''
